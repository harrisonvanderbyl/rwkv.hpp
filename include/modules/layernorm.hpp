...
class LayerNorm
{
    public:
        ...
        Tensor<float> bias;
        Tensor<float> buffer;
        LayerNorm(Tensor<float> weight, Tensor<float> bias, ulong max_batch, ulong max_seq){
            this->weight = weight;
            this->bias = bias;
...
class GroupNorm
{
    public:
        ...
        Tensor<float> buffer;
        ulong head;
        GroupNorm(Tensor<float> weight, Tensor<float> bias, ulong head, ulong max_batch, ulong max_seq){
            this->weight = weight;
            this->bias = bias;
            this->head = head;
